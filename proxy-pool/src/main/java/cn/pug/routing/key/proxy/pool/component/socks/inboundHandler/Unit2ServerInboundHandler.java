...
@Slf4j
public class Unit2ServerInboundHandler extends ChannelInboundHandlerAdapter {

    private final ChannelHandlerContext toBrowserCtx;

    public Unit2ServerInboundHandler(ChannelHandlerContext toBrowserCtx) {
        this.toBrowserCtx = toBrowserCtx;
    }

    @Override
    public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception {
        toBrowserCtx.channel().writeAndFlush(msg);
    }
